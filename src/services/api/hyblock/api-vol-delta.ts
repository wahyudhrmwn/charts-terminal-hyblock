...
export const getVolDelta = async (
  ...
  try {
    ...
    console.error('Error fetching volume delta data:', 
    ...
    return {
      ...
      error: typeof axiosError.response?.data === 'object' && axiosError.response?.data && 'message' in axiosError.response.data
        ...
        : axiosError.message || 'Gagal mendapatkan data volume delta',
